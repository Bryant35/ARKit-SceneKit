...
//    }()
    ...
    override func viewDidLoad() {
        ...
        // Create a new scene
        var scene = SCNScene(named: "art.scnassets/blocks.scn")!
...
//    }
    ...
    func addBuilding(position: SCNVector3){
        guard let Scene = SCNScene(named: "art.scnassets/blocks.scn") else {
            print("gagal load box")
            return
        }
        
        guard let Node = Scene.rootNode.childNode(withName: "scene", recursively: false) else {
...
//    }
    ...
    @objc func handleTap(recognizer: UITapGestureRecognizer){
        ...
        if acc >= 1.5 && lastBall.advanced(by: 0.2).compare(Date()) == .orderedAscending {
            ...
            ballMaterial.diffuse.contents = UIImage(named: "cannonball.jpeg")
